        ...
        <div className='sticky top-0 bg-indigo-900 text-white flex justify-between items-center w-full z-40 py-1'>
            <div className='my-4 text-lg flex justify-start items-center mx-4'>
                ...
                <nav className=' md:block hidden'>
                    <span className='nav'>
                        <Link className='mx-2 px-1 py-2' to='/'><FontAwesomeIcon className='mb-0.5' icon={faUser}></FontAwesomeIcon> Student</Link>
                        <ul className='sub-nav bg-white/70 mt-4 absolute top-12 left-20 p-3'>
                            <li className='text-slate-800 hover:text-blue-800'>Section-1</li>
                            <li className='text-slate-800 hover:text-blue-800'>Section-2</li>
                            <li className='text-slate-800 hover:text-blue-800'>Section-3</li>
                            <li className='text-slate-800 hover:text-blue-800'>Section-4</li>
                            <li className='text-slate-800 hover:text-blue-800'>Section-5</li>
                        </ul>
                    </span>
                    <Link className='mx-2 px-1 hover:underline-offset-8 decoration-2 hover:underline' to='/academics'><FontAwesomeIcon className='mb-0.5' icon={faFeed}></FontAwesomeIcon> TER</Link>
                    <Link className='mx-2 px-1 hover:underline-offset-8 decoration-2 hover:underline' to='/courses'>Application</Link>
                    <Link className='mx-2 px-1 hover:underline-offset-8 decoration-2 hover:underline' to='/campus'>IQAC</Link>
                    <Link className='mx-2 px-1 hover:underline-offset-8 decoration-2 hover:underline' to='/search'>Others</Link>
